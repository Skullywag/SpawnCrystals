package com.skullywag.spawncrystals.tileentity;
...
import com.skullywag.spawncrystals.network.PacketHandler;
...
public class TileEntitySC extends TileEntity
{
    ...
    {
        return PacketHandler.INSTANCE.getPacketFrom(new MessageTileEntitySC(this));
    }
}
